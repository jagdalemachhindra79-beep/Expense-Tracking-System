...
def fatch_expenses_summary(start_date,end_date):
    logger.info(f"fatch_expenses_summary called with start:{start_date}end:{end_date}")
...
if __name__ == "__main__":
    ...
    print(expenses)
    summary =fatch_expenses_summary("2024-08-01","2024-08-05")
    for record in summary:
       print(record)

    #delete_expenses_for_date("2024-08-25")

    insert_expense("2024-08-01",40,"Shopping","bought dairy milk choco")
